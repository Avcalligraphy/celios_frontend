...
export default function BoxPublishing({title, link, image} : BoxPublishingProps) {
  ...
  return (
    <Link
      ...
      className=" flex flex-col items-center bg-[#00130D] rounded-[32px]  h-fit px-[26px] cxl:w-full csm:w-[550px] w-full csm:min-h-[500px] min-h-[400px] py-[35px] translate-x-0 translate-y-0 hover:translate-x-1 hover:translate-y-1 "
    >
      <img
        src={image ? apiURL + image : null}
        className="  csm:w-[212px] w-[182px] bg-cover object-cover csm:h-[312px] h-[282px] rounded-[20px] "
      />
